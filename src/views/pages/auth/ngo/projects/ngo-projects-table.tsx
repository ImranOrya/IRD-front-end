...
import NgoProjectsFilterDialog from "./ngo-projects-filter-dialog";

export function NgoProjectsTable() {
  ...
  const initialize = async (dataFilters: UserFilter) => {
    const count = await getComponentCache(CACHE.PROJECT_TABLE_PAGINATION_COUNT);
